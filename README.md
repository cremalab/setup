New employee workstation setup scripts. See the comments in the `.sh` files to find out what they install. Comment out anything you don't want. Then run them.
